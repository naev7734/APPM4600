...
def driver():
    ...
    Lamb_1 = .01 #lambda, the coefficient for the 1-norm
    Lamb_2 = .25 #lambda for the 2-norm

    fine = 10000 #number of points to use for graphing and error calculation

    'Setup'
    noise = np.random.normal(0,2*h,n) #create gaussian noise where 1 standard deviation is the same as the step size h
